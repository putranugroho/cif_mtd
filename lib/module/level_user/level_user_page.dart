...
class LevelUserPage extends StatelessWidget {
  const LevelUserPage({super.key});

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => LevelUserNotifier(context: context),
      child: Consumer<LevelUserNotifier>(
                                      ...
                                      : ListView.builder(
                                          ...
                                          itemBuilder: (context, i) {
                                            final data = value
                                                ...
                                                .submenu[i];
                                            final menuAccess =
                                                value.menuAccessList.firstWhere(
                                              (e) =>
                                                  e.modul ==
