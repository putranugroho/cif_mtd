...
class GolonganAsetNotifier extends ChangeNotifier {
  ...
  clear() {
    ...
    nosbbppn.clear();
    nosbbpph.clear();
    nossbpenyusutan.clear();
    nosbbrugijual.clear();
    nosbblabajual.clear();
    nosbbbiayapenyusutan.clear();
    namasbbbiayapenyusutan.clear();
    namasbbaset.clear();
    namasbbppn.clear();
    namasbbpph.clear();
    namasbbpenyusutan.clear();
    namasbbrugijual.clear();
    namasbblabajual.clear();
    nama.clear();
    kode.clear();
    masasusut.clear();
    notifyListeners();
    ...
    if (keyForm.currentState!.validate()) {
      if (editData) {
        ...
        var data = {
          ...
          "metode": metodePenyusutanModel!.metodePenyusutan,
          "nilai_akhir": metodePenyusutanModel!.nilaiAkhir.toString(),
          ...
          "sbb_biaya_penyusutan": sbbbiayapenyusutan?.nosbb,
  ...
  InqueryGlModel? sbbbiayapenyusutan;
  ...
  TextEditingController nosbbbiayapenyusutan = TextEditingController();
  TextEditingController namasbbbiayapenyusutan = TextEditingController();
  ...
  pilihSbbBiayaPenyusutan(InqueryGlModel value) {
    sbbbiayapenyusutan = value;
    nosbbbiayapenyusutan.text = value.nosbb;
    namasbbbiayapenyusutan.text = value.namaSbb;
    notifyListeners();
  }
