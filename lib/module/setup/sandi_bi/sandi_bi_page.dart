...
class _View extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final n = context.watch<SandiBiNotifier>();

    return Scaffold(
      appBar: AppBar(
        title: Text(
          n.mode == PeroranganMode.create ? n.steps[n.currentStep].label : 'Data Sandi BI',
        ),
      ),
      body: Padding(
  ...
  Widget _buildBody(BuildContext context, SandiBiNotifier n) {
    switch (n.mode) {
        ...
        return Column(
          children: [
            ...
            ElevatedButton.icon(
              ...
              label: const Text('Tambah Sandi BI'),
            ...
            OutlinedButton.icon(
              ...
              label: const Text('Cari Sandi BI'),
      ...
      case PeroranganMode.search:
        return Column(
          children: [
            TextField(
              decoration: const InputDecoration(labelText: 'Nomor Sandi BI'),
              onChanged: (v) => n.searchNoCif = v,
            ),
            TextField(
              decoration: const InputDecoration(labelText: 'Nama Sandi BI'),
