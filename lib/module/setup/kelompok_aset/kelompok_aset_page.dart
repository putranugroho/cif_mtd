...
class KelompokAsetPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => KelompokAsetNotifier(context: context),
      child: Consumer<KelompokAsetNotifier>(
...
class DetailDataSource extends DataGridSource {
  DetailDataSource(KelompokAsetNotifier value) {
    tindakanNotifier = value;
    buildRowData(value.list);
  }

  KelompokAsetNotifier? tindakanNotifier;

  List<DataGridRow> _laporanData = [];
  @override
  List<DataGridRow> get rows => _laporanData;
  void buildRowData(List<KelompokAsetModel> list) {
    int index = 1;
    _laporanData = list
