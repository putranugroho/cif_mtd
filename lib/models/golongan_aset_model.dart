...
class GolonganAsetModel {
  ...
  factory GolonganAsetModel.fromJson(Map<String, dynamic> json) => GolonganAsetModel(id: json['id'] as int, kodeGolongan: json['kode_golongan'].toString(), namaGolongan: json['nama_golongan'].toString(), masaSusut: json['masa_susut'].toString(), nilaiDeclining: json['nilai_declining'].toString(), sbbAset: json['sbb_aset'] as dynamic, sbbPenyusutan: json['sbb_penyusutan'] as dynamic, sbbBiayaPenyusutan: json['sbb_biaya_penyusutan'] as dynamic, sbbRugiRevaluasi: json['sbb_rugi_revaluasi'] as dynamic, sbbLabaRevaluasi: json['sbb_laba_revaluasi'] as dynamic, sbbRugiJual: json['sbb_rugi_jual'] as dynamic, sbbLabaJual: json['sbb_laba_jual'] as dynamic, sbbPpn: json['sbb_ppn'] as dynamic, sbbPph: json['sbb_pph'] as dynamic, sbbBiayaPerbaikan: json['sbb_biaya_perbaikan'] as dynamic);
  ...
  GolonganAsetModel clone() => GolonganAsetModel(id: id, kodeGolongan: kodeGolongan, namaGolongan: namaGolongan, masaSusut: masaSusut, nilaiDeclining: nilaiDeclining, sbbAset: sbbAset, sbbPenyusutan: sbbPenyusutan, sbbBiayaPenyusutan: sbbBiayaPenyusutan, sbbRugiRevaluasi: sbbRugiRevaluasi, sbbLabaRevaluasi: sbbLabaRevaluasi, sbbRugiJual: sbbRugiJual, sbbLabaJual: sbbLabaJual, sbbPpn: sbbPpn, sbbPph: sbbPph, sbbBiayaPerbaikan: sbbBiayaPerbaikan);

  GolonganAsetModel copyWith({int? id, String? kodeGolongan, String? namaGolongan, String? masaSusut, String? nilaiDeclining, dynamic sbbAset, dynamic sbbPenyusutan, dynamic sbbBiayaPenyusutan, dynamic sbbRugiRevaluasi, dynamic sbbLabaRevaluasi, dynamic sbbRugiJual, dynamic sbbLabaJual, dynamic sbbPpn, dynamic sbbPph, dynamic sbbBiayaPerbaikan}) => GolonganAsetModel(
        id: id ?? this.id,
