...
class SetupHutangPiutangModel {
  ...
  factory SetupHutangPiutangModel.fromJson(Map<String, dynamic> json) => SetupHutangPiutangModel(id: json['id'] as int, kodePt: json['kode_pt'].toString(), sbbtransaksihutang: json['sbbtransaksihutang'].toString(), sbbpphhutang: json['sbbpphhutang'].toString(), sbbppnhutang: json['sbbppnhutang'].toString(), sbbtransaksipiutang: json['sbbtransaksipiutang'].toString(), sbbppnpiutang: json['sbbppnpiutang'].toString(), sbbpphpiutang: json['sbbpphpiutang'].toString(), sbblawanhutang: json['sbblawanhutang'].toString(), sbblawanpiutang: json['sbblawanpiutang'].toString(), sbbhpppiutang: json['sbbhpppiutang'].toString(), sbbpersedianpiutang: json['sbbpersedianpiutang'].toString(), namasbbtransaksihutang: json['namasbbtransaksihutang'].toString(), namasbbpphhutang: json['namasbbpphhutang'].toString(), namasbbppnhutang: json['namasbbppnhutang'].toString(), namasbbtransaksipiutang: json['namasbbtransaksipiutang'].toString(), namasbbpphpiutang: json['namasbbpphpiutang'].toString(), namasbbppnpiutang: json['namasbbppnpiutang'].toString(), namasbblawanhutang: json['namasbblawanhutang'].toString(), namasbblawanpiutang: json['namasbblawanpiutang'].toString(), namasbbhpppiutang: json['namasbbhpppiutang'].toString(), namasbbpersedianpiutang: json['namasbbpersedianpiutang'].toString());
  ...
  SetupHutangPiutangModel clone() => SetupHutangPiutangModel(id: id, kodePt: kodePt, sbbtransaksihutang: sbbtransaksihutang, sbbpphhutang: sbbpphhutang, sbbppnhutang: sbbppnhutang, sbbtransaksipiutang: sbbtransaksipiutang, sbbppnpiutang: sbbppnpiutang, sbbpphpiutang: sbbpphpiutang, sbblawanhutang: sbblawanhutang, sbblawanpiutang: sbblawanpiutang, sbbhpppiutang: sbbhpppiutang, sbbpersedianpiutang: sbbpersedianpiutang, namasbbtransaksihutang: namasbbtransaksihutang, namasbbpphhutang: namasbbpphhutang, namasbbppnhutang: namasbbppnhutang, namasbbtransaksipiutang: namasbbtransaksipiutang, namasbbpphpiutang: namasbbpphpiutang, namasbbppnpiutang: namasbbppnpiutang, namasbblawanhutang: namasbblawanhutang, namasbblawanpiutang: namasbblawanpiutang, namasbbhpppiutang: namasbbhpppiutang, namasbbpersedianpiutang: namasbbpersedianpiutang);

  SetupHutangPiutangModel copyWith({int? id, String? kodePt, String? sbbtransaksihutang, String? sbbpphhutang, String? sbbppnhutang, String? sbbtransaksipiutang, String? sbbppnpiutang, String? sbbpphpiutang, String? sbblawanhutang, String? sbblawanpiutang, String? sbbhpppiutang, String? sbbpersedianpiutang, String? namasbbtransaksihutang, String? namasbbpphhutang, String? namasbbppnhutang, String? namasbbtransaksipiutang, String? namasbbpphpiutang, String? namasbbppnpiutang, String? namasbblawanhutang, String? namasbblawanpiutang, String? namasbbhpppiutang, String? namasbbpersedianpiutang}) => SetupHutangPiutangModel(
        id: id ?? this.id,
