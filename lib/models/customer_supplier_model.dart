...
class CustomerSupplierModel {
  ...
  factory CustomerSupplierModel.fromJson(Map<String,dynamic> json) => CustomerSupplierModel(
    ...
    kodeAoCustomer: json['kode_ao_customer'] as dynamic,
    kodeAoSupplier: json['kode_ao_supplier'] as dynamic,
    namaAoCustomer: json['nama_ao_customer'] as dynamic,
    namaAoSupplier: json['nama_ao_supplier'] as dynamic
  );
  ...
  CustomerSupplierModel clone() => CustomerSupplierModel(
    ...
    email3: email3,
    keterangan3: keterangan3,
    kodeAoCustomer: kodeAoCustomer,
    kodeAoSupplier: kodeAoSupplier,
    namaAoCustomer: namaAoCustomer,
    namaAoSupplier: namaAoSupplier
  );
  ...
  CustomerSupplierModel copyWith({
    ...
    String? email3,
    String? keterangan3,
    dynamic? kodeAoCustomer,
    dynamic? kodeAoSupplier,
    dynamic? namaAoCustomer,
    dynamic? namaAoSupplier
