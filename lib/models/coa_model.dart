...
class CoaModel {
  ...
  factory CoaModel.fromJson(Map<String, dynamic> json) => CoaModel(id: json['id'] as int, golAcc: json['gol_acc'].toString(), jnsAcc: json['jns_acc'].toString(), nobb: json['nobb'].toString(), nosbb: json['nosbb'].toString(), namaSbb: json['nama_sbb'].toString(), typePosting: json['type_posting'].toString(), sbbKhusus: json['sbb_khusus'].toString(), createddate: json['createddate'].toString(), isDeleted: json['is_deleted'].toString(), kodePt: json['kode_pt'].toString(), kodeKantor: json['kode_kantor'].toString(), limitDebet: json['limit_debet'].toString(), limitKredit: json['limit_kredit'].toString(), akunPerantara: json['akun_perantara'].toString(), hutang: json['hutang'].toString(), piutang: json['piutang'].toString());
  ...
  CoaModel clone() => CoaModel(id: id, golAcc: golAcc, jnsAcc: jnsAcc, nobb: nobb, nosbb: nosbb, namaSbb: namaSbb, typePosting: typePosting, sbbKhusus: sbbKhusus, createddate: createddate, isDeleted: isDeleted, kodePt: kodePt, kodeKantor: kodeKantor, limitDebet: limitDebet, limitKredit: limitKredit, akunPerantara: akunPerantara, hutang: hutang, piutang: piutang);

  CoaModel copyWith({int? id, String? golAcc, String? jnsAcc, String? nobb, String? nosbb, String? namaSbb, String? typePosting, String? sbbKhusus, String? createddate, String? isDeleted, String? kodePt, String? kodeKantor, String? limitDebet, String? limitKredit, String? akunPerantara, String? hutang, String? piutang}) => CoaModel(
        id: id ?? this.id,
