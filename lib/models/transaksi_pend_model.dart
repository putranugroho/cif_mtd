...
class TransaksiPendModel {
  ...
  factory TransaksiPendModel.fromJson(Map<String, dynamic> json) => TransaksiPendModel(id: json['id'] as int, tglTransaksi: json['tgl_transaksi'].toString(), tglValuta: json['tgl_valuta'].toString(), batch: json['batch'].toString(), trxType: json['trx_type'].toString(), trxCode: json['trx_code'].toString(), otor: json['otor'].toString(), kodeTrn: json['kode_trn'].toString(), dracc: json['dracc'].toString(), namaDr: json['nama_dr'].toString(), cracc: json['cracc'].toString(), namaCr: json['nama_cr'].toString(), rrn: json['rrn'].toString(), noDokumen: json['no_dokumen'].toString(), modul: json['modul'].toString(), keteranganOtor: json['keterangan_otor'].toString(), alasan: json['alasan'].toString(), noRef: json['no_ref'].toString(), nominal: json['nominal'].toString(), keterangan: json['keterangan'].toString(), kodePt: json['kode_pt'].toString(), kodeKantor: json['kode_kantor'].toString(), kodeInduk: json['kode_induk'].toString(), stsValidasi: json['sts_validasi'].toString(), kodeAoDr: json['kode_ao_dr'].toString(), kodeColl: json['kode_coll'].toString(), kodeAoCr: json['kode_ao_cr'].toString(), userinput: json['userinput'].toString(), userterm: json['userterm'].toString(), inputtgljam: json['inputtgljam'].toString(), otoruser: json['otoruser'].toString(), otorterm: json['otorterm'].toString(), otortgljam: json['otortgljam'].toString(), flagTrn: json['flag_trn'].toString(), merchant: json['merchant'].toString(), sourceTrx: json['source_trx'].toString(), createddate: json['createddate'].toString(), status: json['status'].toString());
  ...
  TransaksiPendModel clone() => TransaksiPendModel(id: id, tglTransaksi: tglTransaksi, tglValuta: tglValuta, batch: batch, trxType: trxType, trxCode: trxCode, otor: otor, kodeTrn: kodeTrn, dracc: dracc, namaDr: namaDr, cracc: cracc, namaCr: namaCr, rrn: rrn, noDokumen: noDokumen, modul: modul, keteranganOtor: keteranganOtor, alasan: alasan, noRef: noRef, nominal: nominal, keterangan: keterangan, kodePt: kodePt, kodeKantor: kodeKantor, kodeInduk: kodeInduk, stsValidasi: stsValidasi, kodeAoDr: kodeAoDr, kodeColl: kodeColl, kodeAoCr: kodeAoCr, userinput: userinput, userterm: userterm, inputtgljam: inputtgljam, otoruser: otoruser, otorterm: otorterm, otortgljam: otortgljam, flagTrn: flagTrn, merchant: merchant, sourceTrx: sourceTrx, createddate: createddate, status: status);

  TransaksiPendModel copyWith({int? id, String? tglTransaksi, String? tglValuta, String? batch, String? trxType, String? trxCode, String? otor, String? kodeTrn, String? dracc, String? namaDr, String? cracc, String? namaCr, String? rrn, String? noDokumen, String? modul, String? keteranganOtor, String? alasan, String? noRef, String? nominal, String? keterangan, String? kodePt, String? kodeKantor, String? kodeInduk, String? stsValidasi, String? kodeAoDr, String? kodeColl, String? kodeAoCr, String? userinput, String? userterm, String? inputtgljam, String? otoruser, String? otorterm, String? otortgljam, String? flagTrn, String? merchant, String? sourceTrx, String? createddate, String? status}) => TransaksiPendModel(
        id: id ?? this.id,
