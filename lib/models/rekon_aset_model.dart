...
class RekonAsetModel {
  ...
  factory RekonAsetModel.fromJson(Map<String,dynamic> json) => RekonAsetModel(
    kodeKelompok: json['kode_kelompok'].toString(),
    namaKelompok: json['nama_kelompok'].toString(),
    item: (json['item'] as List? ?? []).map((e) => InventarisModel.fromJson(e as Map<String, dynamic>)).toList()
  );
  ...
  RekonAsetModel clone() => RekonAsetModel(
  ...
  RekonAsetModel copyWith({
    String? kodeKelompok,
    String? namaKelompok,
    List<InventarisModel>? item
  }) => RekonAsetModel(
  ...
  bool operator ==(Object other) => identical(this, other)
    || other is RekonAsetModel && kodeKelompok == other.kodeKelompok && namaKelompok == other.namaKelompok && item == other.item;
