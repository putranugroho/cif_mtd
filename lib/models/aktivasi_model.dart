...
class AktivasiModel {
  ...
  bool operator ==(Object other) => identical(this, other)
    || other is AktivasiModel && id == other.id && kdAktivasi == other.kdAktivasi && nmAktivasi == other.nmAktivasi && hari == other.hari && jamMulai == other.jamMulai && jamSelesai == other.jamSelesai && createdDate == other.createdDate;
