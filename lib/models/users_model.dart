...
class UsersModel {
  ...
  factory UsersModel.fromJson(Map<String, dynamic> json) => UsersModel(id: json['id'] as int, userid: json['userid'].toString(), empId: json['emp_id'].toString(), pass: json['pass'].toString(), namauser: json['namauser'].toString(), batch: json['batch'].toString(), kodePt: json['kode_pt'].toString(), kodeKantor: json['kode_kantor'].toString(), kodeInduk: json['kode_induk'].toString(), tglexp: json['tglexp'].toString(), lvluser: json['lvluser'].toString(), terminalId: json['terminal_id'].toString(), aktivasi: json['aktivasi'].toString(), aksesKasir: json['akses_kasir'].toString(), limitAkses: json['limit_akses'].toString(), maksimalTransaksi: json['maksimal_transaksi'].toString(), sbbKasir: json['sbb_kasir'].toString(), namaSbb: json['nama_sbb'].toString(), fhoto1: json['fhoto_1'].toString(), fhoto2: json['fhoto_2'].toString(), fhoto3: json['fhoto_3'].toString(), levelOtor: json['level_otor'].toString(), bedaKantor: json['beda_kantor'].toString(), minOtor: json['min_otor'].toString(), maxOtor: json['max_otor'].toString(), createddate: json['createddate'].toString(), isDeleted: json['is_deleted'].toString(), backDate: json['back_date'].toString(), shifts: (json['shifts'] as List? ?? []).map((e) => UsersShiftModel.fromJson(e as Map<String, dynamic>)).toList());
  ...
  UsersModel clone() => UsersModel(id: id, userid: userid, empId: empId, pass: pass, namauser: namauser, batch: batch, kodePt: kodePt, kodeKantor: kodeKantor, kodeInduk: kodeInduk, tglexp: tglexp, lvluser: lvluser, terminalId: terminalId, aktivasi: aktivasi, aksesKasir: aksesKasir, limitAkses: limitAkses, maksimalTransaksi: maksimalTransaksi, sbbKasir: sbbKasir, namaSbb: namaSbb, fhoto1: fhoto1, fhoto2: fhoto2, fhoto3: fhoto3, levelOtor: levelOtor, bedaKantor: bedaKantor, minOtor: minOtor, maxOtor: maxOtor, createddate: createddate, isDeleted: isDeleted, backDate: backDate, shifts: shifts.map((e) => e.clone()).toList());

  UsersModel copyWith({int? id, String? userid, String? empId, String? pass, String? namauser, String? batch, String? kodePt, String? kodeKantor, String? kodeInduk, String? tglexp, String? lvluser, String? terminalId, String? aktivasi, String? aksesKasir, String? limitAkses, String? maksimalTransaksi, String? sbbKasir, String? namaSbb, String? fhoto1, String? fhoto2, String? fhoto3, String? levelOtor, String? bedaKantor, String? minOtor, String? maxOtor, String? createddate, String? isDeleted, String? backDate, List<UsersShiftModel>? shifts}) => UsersModel(
        id: id ?? this.id,
