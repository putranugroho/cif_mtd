...
class InventarisTransaksiModel {
  ...
  factory InventarisTransaksiModel.fromJson(Map<String,dynamic> json) => InventarisTransaksiModel(
    id: json['id'] as int,
    kelompokAset: json['kelompok_aset'].toString(),
    golonganAset: json['golongan_aset'].toString(),
    nomorAset: json['nomor_aset'].toString(),
    satuan: json['satuan'].toString(),
    namaAset: json['nama_aset'].toString(),
    keterangan: json['keterangan'].toString(),
    noDokumenPembelian: json['no_dokumen_pembelian'].toString(),
    tanggalBeli: json['tanggal_beli'].toString(),
    tanggalTerima: json['tanggal_terima'].toString(),
    jenisPenempatan: json['jenis_penempatan'].toString(),
    namaKantor: json['nama_kantor'].toString(),
    lokasi: json['lokasi'].toString(),
    kota: json['kota'].toString(),
    nilaiAkhir: json['nilai_akhir'].toString(),
    masaSusut: json['masa_susut'] as int,
    bulanMulaiSusut: json['bulan_mulai_susut'].toString(),
    tanggalValuta: json['tanggal_valuta'].toString(),
    noDokumenTransaksi: json['no_dokumen_transaksi'].toString(),
    nilaiTransaksi: json['nilai_transaksi'].toString(),
    keteranganTransaksi: json['keterangan_transaksi'].toString(),
    ...
    nipPegawai: json['nip_pegawai'].toString(),
    statusRec: json['status_rec'].toString(),
    ...
    deltgljam: json['deltgljam'] as dynamic,
  ...
  InventarisTransaksiModel clone() => InventarisTransaksiModel(
    id: id,
    kelompokAset: kelompokAset,
    golonganAset: golonganAset,
    nomorAset: nomorAset,
    satuan: satuan,
    namaAset: namaAset,
    keterangan: keterangan,
    noDokumenPembelian: noDokumenPembelian,
    ...
    masaSusut: masaSusut,
    bulanMulaiSusut: bulanMulaiSusut,
    tanggalValuta: tanggalValuta,
    noDokumenTransaksi: noDokumenTransaksi,
    ...
    auttgljam: auttgljam,
    autterm: autterm,
    persentasePenyusutan: persentasePenyusutan,
  ...
  InventarisTransaksiModel copyWith({
    int? id,
    String? kelompokAset,
    String? golonganAset,
    String? nomorAset,
    ...
    String? namaAset,
    String? keterangan,
    String? noDokumenPembelian,
    String? tanggalBeli,
    String? tanggalTerima,
    String? jenisPenempatan,
    String? namaKantor,
    String? lokasi,
    String? kota,
    String? nilaiAkhir,
    int? masaSusut,
    String? bulanMulaiSusut,
    String? tanggalValuta,
    String? noDokumenTransaksi,
