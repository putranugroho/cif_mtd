...
class KelompokAsetModel {
  ...
  factory KelompokAsetModel.fromJson(Map<String,dynamic> json) => KelompokAsetModel(
    ...
    namaKelompokn: json['nama_kelompokn'].toString()
  );
  ...
  bool operator ==(Object other) => identical(this, other)
    || other is KelompokAsetModel && id == other.id && kodeKelompok == other.kodeKelompok && namaKelompokn == other.namaKelompokn;
