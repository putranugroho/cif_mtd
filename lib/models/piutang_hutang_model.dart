...
class PiutangHutangModel {
  ...
  factory PiutangHutangModel.fromJson(Map<String, dynamic> json) => PiutangHutangModel(id: json['id'] as int, noInvoice: json['no_invoice'].toString(), jnsInvoice: json['jns_invoice'].toString(), noSif: json['no_sif'].toString(), nmSif: json['nm_sif'].toString(), tglInvoice: json['tgl_invoice'].toString(), nilaiInvoice: json['nilai_invoice'].toString(), ppn: json['ppn'].toString(), pph: json['pph'].toString(), tglJtTempo: json['tgl_jt_tempo'].toString(), bertahap: json['bertahap'].toString(), jumlahTahap: json['jumlah_tahap'].toString(), tglBayar: json['tgl_bayar'].toString(), nilaiBayar: json['nilai_bayar'].toString(), statusInvoice: json['status_invoice'].toString(), noSbb: json['no_sbb'].toString(), namaSbb: json['nama_sbb'].toString(), kodePt: json['kode_pt'].toString(), kodeKantor: json['kode_kantor'].toString(), kodeInduk: json['kode_induk'].toString(), keterangan: json['keterangan'].toString(), kodeAo: json['kode_ao'].toString(), itemPembayaran: (json['item_pembayaran'] as List? ?? []).map((e) => PembayaranHutangPiutangModel.fromJson(e as Map<String, dynamic>)).toList());
  ...
  PiutangHutangModel clone() => PiutangHutangModel(id: id, noInvoice: noInvoice, jnsInvoice: jnsInvoice, noSif: noSif, nmSif: nmSif, tglInvoice: tglInvoice, nilaiInvoice: nilaiInvoice, ppn: ppn, pph: pph, tglJtTempo: tglJtTempo, bertahap: bertahap, jumlahTahap: jumlahTahap, tglBayar: tglBayar, nilaiBayar: nilaiBayar, statusInvoice: statusInvoice, noSbb: noSbb, namaSbb: namaSbb, kodePt: kodePt, kodeKantor: kodeKantor, kodeInduk: kodeInduk, keterangan: keterangan, kodeAo: kodeAo, itemPembayaran: itemPembayaran.map((e) => e.clone()).toList());

  PiutangHutangModel copyWith({int? id, String? noInvoice, String? jnsInvoice, String? noSif, String? nmSif, String? tglInvoice, String? nilaiInvoice, String? ppn, String? pph, String? tglJtTempo, String? bertahap, String? jumlahTahap, String? tglBayar, String? nilaiBayar, String? statusInvoice, String? noSbb, String? namaSbb, String? kodePt, String? kodeKantor, String? kodeInduk, String? keterangan, String? kodeAo, List<PembayaranHutangPiutangModel>? itemPembayaran}) => PiutangHutangModel(
        id: id ?? this.id,
