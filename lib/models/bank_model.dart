...
class BankModel {
  ...
  factory BankModel.fromJson(Map<String,dynamic> json) => BankModel(
    ...
    noBilyet: json['no_bilyet'] as dynamic,
  ...
  bool operator ==(Object other) => identical(this, other)
    || other is BankModel && id == other.id && kodeBank == other.kodeBank && nmBank == other.nmBank && nmRek == other.nmRek && noBilyet == other.noBilyet && noRek == other.noRek && cabang == other.cabang && kdRek == other.kdRek && nosbb == other.nosbb && namaSbb == other.namaSbb && nominal == other.nominal && jw == other.jw && tglbuka == other.tglbuka && tgljtempo == other.tgljtempo && saldoeom == other.saldoeom && kodePt == other.kodePt && kodeKantor == other.kodeKantor && kodeInduk == other.kodeInduk && createddate == other.createddate && isDeleted == other.isDeleted;
