...
class PerusahaanModel {
  ...
  factory PerusahaanModel.fromJson(Map<String,dynamic> json) => PerusahaanModel(
    ...
    dirut: json['dirut'].toString(),
    dirKeuangan: json['dir_keuangan'].toString(),
    dirOperasi: json['dir_operasi'].toString()
  );
  ...
  PerusahaanModel clone() => PerusahaanModel(
    kodePt: kodePt,
    namaPt: namaPt,
    alamat: alamat,
    kelurahan: kelurahan,
    ...
    npwp: npwp,
    dirut: dirut,
    dirKeuangan: dirKeuangan,
    dirOperasi: dirOperasi
  );


  PerusahaanModel copyWith({
    String? kodePt,
    String? namaPt,
    String? alamat,
    String? kelurahan,
  ...
  bool operator ==(Object other) => identical(this, other)
    || other is PerusahaanModel && kodePt == other.kodePt && namaPt == other.namaPt && alamat == other.alamat && kelurahan == other.kelurahan && kecamatan == other.kecamatan && kota == other.kota && provinsi == other.provinsi && kodePos == other.kodePos && npwp == other.npwp && dirut == other.dirut && dirKeuangan == other.dirKeuangan && dirOperasi == other.dirOperasi;
