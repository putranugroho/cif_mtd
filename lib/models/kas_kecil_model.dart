...
class KasKecilModel {
  ...
  factory KasKecilModel.fromJson(Map<String,dynamic> json) => KasKecilModel(
    id: json['id'] as int,
    kodePt: json['kode_pt'].toString(),
    nosbbKasKecil: json['nosbb_kas_kecil'].toString(),
    namasbbKaskecil: json['namasbb_kaskecil'].toString(),
    nosbbKasBon: json['nosbb_kas_bon'].toString(),
    namasbbKasbon: json['namasbb_kasbon'].toString(),
  ...
  KasKecilModel clone() => KasKecilModel(
    id: id,
    kodePt: kodePt,
    nosbbKasKecil: nosbbKasKecil,
    namasbbKaskecil: namasbbKaskecil,
    nosbbKasBon: nosbbKasBon,
    namasbbKasbon: namasbbKasbon,
    createddate: createddate
  );


  KasKecilModel copyWith({
    int? id,
    String? kodePt,
    String? nosbbKasKecil,
    String? namasbbKaskecil,
    String? nosbbKasBon,
    String? namasbbKasbon,
    String? createddate
  }) => KasKecilModel(
    id: id ?? this.id,
  ...
  bool operator ==(Object other) => identical(this, other)
    || other is KasKecilModel && id == other.id && kodePt == other.kodePt && nosbbKasKecil == other.nosbbKasKecil && namasbbKaskecil == other.namasbbKaskecil && nosbbKasBon == other.nosbbKasBon && namasbbKasbon == other.namasbbKasbon && createddate == other.createddate;
