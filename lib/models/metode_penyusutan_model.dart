...
class MetodePenyusutanModel {
  ...
  bool operator ==(Object other) => identical(this, other)
    || other is MetodePenyusutanModel && id == other.id && metodePenyusutan == other.metodePenyusutan && nilaiAkhir == other.nilaiAkhir && kodePt == other.kodePt;

  @override
  int get hashCode => id.hashCode ^ metodePenyusutan.hashCode ^ nilaiAkhir.hashCode ^ kodePt.hashCode;
}
