...
class InventarisModel {
  ...
  factory InventarisModel.fromJson(Map<String, dynamic> json) => InventarisModel(id: json['id'] as int, kdaset: json['kdaset'].toString(), namaaset: json['namaaset'].toString(), ket: json['ket'].toString(), kodeKelompok: json['kode_kelompok'].toString(), namaKelompok: json['nama_kelompok'].toString(), kodeGolongan: json['kode_golongan'].toString(), namaGolongan: json['nama_golongan'].toString(), nodokBeli: json['nodok_beli'].toString(), tglBeli: json['tgl_beli'].toString(), tglTerima: json['tgl_terima'].toString(), habeli: json['habeli'].toString(), disc: json['disc'].toString(), biaya: json['biaya'].toString(), haper: json['haper'].toString(), nilaiResidu: json['nilai_residu'].toString(), ppnBeli: json['ppn_beli'].toString(), pph: json['pph'].toString(), tglJual: json['tgl_jual'].toString(), nodokJual: json['nodok_jual'].toString(), hajual: json['hajual'].toString(), ppnJual: json['ppn_jual'].toString(), margin: json['margin'].toString(), kodePt: json['kode_pt'].toString(), kodeKantor: json['kode_kantor'].toString(), kodeInduk: json['kode_induk'].toString(), lokasi: json['lokasi'].toString(), kota: json['kota'].toString(), masasusut: json['masasusut'].toString(), blnMulaiSusut: json['bln_mulai_susut'].toString(), kdkondisi: json['kdkondisi'].toString(), kondisi: json['kondisi'].toString(), satuanAset: json['satuan_aset'].toString(), nilaiDeclining: json['nilai_declining'].toString(), tglRevaluasi: json['tgl_revaluasi'].toString(), picRevaluasi: json['pic_revaluasi'].toString(), nilaiBuku: json['nilai_buku'].toString(), totalSusut: json['total_susut'].toString(), susutKe: json['susut_ke'].toString(), perbaikan: json['perbaikan'].toString(), stsasr: json['stsasr'].toString(), nopolis: json['nopolis'].toString(), nilaiRevaluasi: json['nilai_revaluasi'].toString(), nik: json['nik'].toString(), namaPejabat: json['nama_pejabat'].toString(), sbbAset: json['sbb_aset'].toString(), sbbPenyusutan: json['sbb_penyusutan'].toString(), sbbBiayaPenyusutan: json['sbb_biaya_penyusutan'].toString(), sbbRugiRevaluasi: json['sbb_rugi_revaluasi'].toString(), sbbLabaRevaluasi: json['sbb_laba_revaluasi'].toString(), sbbRugiJual: json['sbb_rugi_jual'].toString(), sbbLabaJual: json['sbb_laba_jual'].toString(), sbbBiayaPerbaikan: json['sbb_biaya_perbaikan'].toString());
  ...
  InventarisModel clone() => InventarisModel(id: id, kdaset: kdaset, namaaset: namaaset, ket: ket, kodeKelompok: kodeKelompok, namaKelompok: namaKelompok, kodeGolongan: kodeGolongan, namaGolongan: namaGolongan, nodokBeli: nodokBeli, tglBeli: tglBeli, tglTerima: tglTerima, habeli: habeli, disc: disc, biaya: biaya, haper: haper, nilaiResidu: nilaiResidu, ppnBeli: ppnBeli, pph: pph, tglJual: tglJual, nodokJual: nodokJual, hajual: hajual, ppnJual: ppnJual, margin: margin, kodePt: kodePt, kodeKantor: kodeKantor, kodeInduk: kodeInduk, lokasi: lokasi, kota: kota, masasusut: masasusut, blnMulaiSusut: blnMulaiSusut, kdkondisi: kdkondisi, kondisi: kondisi, satuanAset: satuanAset, nilaiDeclining: nilaiDeclining, tglRevaluasi: tglRevaluasi, picRevaluasi: picRevaluasi, nilaiBuku: nilaiBuku, totalSusut: totalSusut, susutKe: susutKe, perbaikan: perbaikan, stsasr: stsasr, nopolis: nopolis, nilaiRevaluasi: nilaiRevaluasi, nik: nik, namaPejabat: namaPejabat, sbbAset: sbbAset, sbbPenyusutan: sbbPenyusutan, sbbBiayaPenyusutan: sbbBiayaPenyusutan, sbbRugiRevaluasi: sbbRugiRevaluasi, sbbLabaRevaluasi: sbbLabaRevaluasi, sbbRugiJual: sbbRugiJual, sbbLabaJual: sbbLabaJual, sbbBiayaPerbaikan: sbbBiayaPerbaikan);

  InventarisModel copyWith({int? id, String? kdaset, String? namaaset, String? ket, String? kodeKelompok, String? namaKelompok, String? kodeGolongan, String? namaGolongan, String? nodokBeli, String? tglBeli, String? tglTerima, String? habeli, String? disc, String? biaya, String? haper, String? nilaiResidu, String? ppnBeli, String? pph, String? tglJual, String? nodokJual, String? hajual, String? ppnJual, String? margin, String? kodePt, String? kodeKantor, String? kodeInduk, String? lokasi, String? kota, String? masasusut, String? blnMulaiSusut, String? kdkondisi, String? kondisi, String? satuanAset, String? nilaiDeclining, String? tglRevaluasi, String? picRevaluasi, String? nilaiBuku, String? totalSusut, String? susutKe, String? perbaikan, String? stsasr, String? nopolis, String? nilaiRevaluasi, String? nik, String? namaPejabat, String? sbbAset, String? sbbPenyusutan, String? sbbBiayaPenyusutan, String? sbbRugiRevaluasi, String? sbbLabaRevaluasi, String? sbbRugiJual, String? sbbLabaJual, String? sbbBiayaPerbaikan}) => InventarisModel(
        id: id ?? this.id,
