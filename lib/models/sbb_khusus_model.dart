...
class SbbKhususModel {
  ...
  factory SbbKhususModel.fromJson(Map<String,dynamic> json) => SbbKhususModel(
    kodeGolongan: json['kode_golongan'].toString(),
    namaGolongan: json['nama_golongan'].toString(),
    items: (json['items'] as List? ?? []).map((e) => SbbKhususItemModel.fromJson(e as Map<String, dynamic>)).toList()
  );
  ...
  SbbKhususModel clone() => SbbKhususModel(
  ...
  SbbKhususModel copyWith({
    String? kodeGolongan,
    String? namaGolongan,
    List<SbbKhususItemModel>? items
  }) => SbbKhususModel(
  ...
  bool operator ==(Object other) => identical(this, other)
    || other is SbbKhususModel && kodeGolongan == other.kodeGolongan && namaGolongan == other.namaGolongan && items == other.items;
