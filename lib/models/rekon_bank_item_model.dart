...
class RekonBankItemModel {
  ...
  factory RekonBankItemModel.fromJson(Map<String,dynamic> json) => RekonBankItemModel(
    ...
    saldoSistem: (json['saldo_sistem'] as num).toDouble()
  );
  ...
  RekonBankItemModel clone() => RekonBankItemModel(
    nosbb: nosbb,
    namaSbb: namaSbb,
  ...
  bool operator ==(Object other) => identical(this, other)
    || other is RekonBankItemModel && nosbb == other.nosbb && namaSbb == other.namaSbb && typePosting == other.typePosting && tglTransaksi == other.tglTransaksi && saldo == other.saldo && saldoSistem == other.saldoSistem;
