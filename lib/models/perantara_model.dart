...
@immutable
class PerantaraModel {

  const PerantaraModel({
    required this.id,
  ...
  final String status;
  final int sisaSaldo;
  final List<PerantaraModel> transaksi;

  factory PerantaraModel.fromJson(Map<String,dynamic> json) => PerantaraModel(
    id: json['id'] as int,
    ...
    sisaSaldo: json['sisa_saldo'] as int,
    transaksi: (json['transaksi'] as List? ?? []).map((e) => PerantaraModel.fromJson(e as Map<String, dynamic>)).toList()
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    'transaksi': transaksi.map((e) => e.toJson()).toList()
  };

  PerantaraModel clone() => PerantaraModel(
    id: id,
    ...
    status: status,
    sisaSaldo: sisaSaldo,
    transaksi: transaksi.map((e) => e.clone()).toList()
  );


  PerantaraModel copyWith({
    int? id,
    String? tglTransaksi,
    String? tglValuta,
    String? batch,
