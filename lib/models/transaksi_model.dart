...
class TransaksiModel {
  ...
  factory TransaksiModel.fromJson(Map<String, dynamic> json) => TransaksiModel(id: json['id'] as int, tglTrans: json['tgl_trans'].toString(), tglVal: json['tgl_val'].toString(), transUser: json['trans_user'].toString(), trxCode: json['trx_code'].toString(), batch: json['batch'].toString(), otor: json['otor'].toString(), noTrans: json['no_trans'] as dynamic, kodeTrans: json['kode_trans'].toString(), debetAcc: json['debet_acc'].toString(), namaDebet: json['nama_debet'].toString(), creditAcc: json['credit_acc'].toString(), namaCredit: json['nama_credit'].toString(), rrn: json['rrn'].toString(), nomorDok: json['nomor_dok'].toString(), nomorRef: json['nomor_ref'].toString(), nominal: json['nominal'].toString(), keterangan: json['keterangan'].toString(), kodePt: json['kode_pt'].toString(), kodeKantor: json['kode_kantor'].toString(), kodeInduk: json['kode_induk'].toString(), statusValidasi: json['status_validasi'].toString(), kodeAoDebet: json['kode_ao_debet'].toString(), kodeAoCredit: json['kode_ao_credit'].toString(), statusTransaksi: json['status_transaksi'].toString(), transid: json['transid'].toString(), merchant: json['merchant'].toString(), sourceTrx: json['source_trx'].toString(), inpuser: json['inpuser'].toString(), inptgljam: json['inptgljam'].toString(), inpterm: json['inpterm'].toString(), chguser: json['chguser'] as dynamic, chgtgljam: json['chgtgljam'] as dynamic, chgterm: json['chgterm'] as dynamic, autuser: json['autuser'].toString(), auttgljam: json['auttgljam'] as dynamic, autterm: json['autterm'] as dynamic, flagTrn: json['flag_trn'].toString(), autrevuser: json['autrevuser'] as dynamic, userterm: json['userterm'] as dynamic, userinput: json['userinput'] as dynamic, inputtgljam: json['inputtgljam'] as dynamic, autrevtgljam: json['autrevtgljam'] as dynamic, autrevterm: json['autrevterm'].toString(), kodeColl: json['kode_coll'].toString(), otoruser: json['otoruser'].toString(), otorterm: json['otorterm'].toString(), otortgljam: json['otortgljam'].toString());
  ...
  TransaksiModel clone() => TransaksiModel(id: id, tglTrans: tglTrans, tglVal: tglVal, transUser: transUser, trxCode: trxCode, batch: batch, otor: otor, noTrans: noTrans, kodeTrans: kodeTrans, debetAcc: debetAcc, namaDebet: namaDebet, creditAcc: creditAcc, namaCredit: namaCredit, rrn: rrn, nomorDok: nomorDok, nomorRef: nomorRef, nominal: nominal, keterangan: keterangan, kodePt: kodePt, kodeKantor: kodeKantor, kodeInduk: kodeInduk, statusValidasi: statusValidasi, kodeAoDebet: kodeAoDebet, kodeAoCredit: kodeAoCredit, statusTransaksi: statusTransaksi, transid: transid, merchant: merchant, sourceTrx: sourceTrx, inpuser: inpuser, inptgljam: inptgljam, inpterm: inpterm, chguser: chguser, chgtgljam: chgtgljam, chgterm: chgterm, autuser: autuser, auttgljam: auttgljam, autterm: autterm, flagTrn: flagTrn, autrevuser: autrevuser, userterm: userterm, userinput: userinput, inputtgljam: inputtgljam, autrevtgljam: autrevtgljam, autrevterm: autrevterm, kodeColl: kodeColl, otoruser: otoruser, otorterm: otorterm, otortgljam: otortgljam);

  TransaksiModel copyWith({int? id, String? tglTrans, String? tglVal, String? transUser, String? trxCode, String? batch, String? otor, dynamic noTrans, String? kodeTrans, String? debetAcc, String? namaDebet, String? creditAcc, String? namaCredit, String? rrn, String? nomorDok, String? nomorRef, String? nominal, String? keterangan, String? kodePt, String? kodeKantor, String? kodeInduk, String? statusValidasi, String? kodeAoDebet, String? kodeAoCredit, String? statusTransaksi, String? transid, String? merchant, String? sourceTrx, String? inpuser, String? inptgljam, String? inpterm, dynamic chguser, dynamic chgtgljam, dynamic chgterm, String? autuser, dynamic auttgljam, dynamic autterm, String? flagTrn, dynamic autrevuser, dynamic userterm, dynamic userinput, dynamic inputtgljam, dynamic autrevtgljam, String? autrevterm, String? kodeColl, String? otoruser, String? otorterm, String? otortgljam}) => TransaksiModel(
        id: id ?? this.id,
