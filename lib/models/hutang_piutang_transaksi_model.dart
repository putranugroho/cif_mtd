...
class HutangPiutangTransaksiModel {
  ...
  factory HutangPiutangTransaksiModel.fromJson(Map<String, dynamic> json) => HutangPiutangTransaksiModel(nokontrak: json['nokontrak'].toString(), namaSif: json['nama_sif'].toString(), alamat: json['alamat'].toString(), tglKontrak: json['tgl_kontrak'].toString(), jenisTransaksi: json['jenis_transaksi'].toString(), keterangan: json['keterangan'].toString(), noRef: json['no_ref'].toString(), custsupp: json['custsupp'].toString(), tipeTransaksi: json['tipe_transaksi'].toString(), noinv: json['noinv'] as dynamic, jangkawaktu: json['jangkawaktu'].toString(), totalTagPokok: json['total_tag_pokok'].toString(), totalTagPpn: json['total_tag_ppn'].toString(), totalTagPph: json['total_tag_pph'].toString(), totalByrPokok: json['total_byr_pokok'].toString(), totalByrPpn: json['total_byr_ppn'].toString(), totalByrPph: json['total_byr_pph'].toString());
  ...
  HutangPiutangTransaksiModel clone() => HutangPiutangTransaksiModel(nokontrak: nokontrak, namaSif: namaSif, alamat: alamat, tglKontrak: tglKontrak, jenisTransaksi: jenisTransaksi, keterangan: keterangan, noRef: noRef, custsupp: custsupp, tipeTransaksi: tipeTransaksi, noinv: noinv, jangkawaktu: jangkawaktu, totalTagPokok: totalTagPokok, totalTagPpn: totalTagPpn, totalTagPph: totalTagPph, totalByrPokok: totalByrPokok, totalByrPpn: totalByrPpn, totalByrPph: totalByrPph);

  HutangPiutangTransaksiModel copyWith({String? nokontrak, String? namaSif, String? alamat, String? tglKontrak, String? jenisTransaksi, String? keterangan, String? noRef, String? custsupp, String? tipeTransaksi, dynamic noinv, String? jangkawaktu, String? totalTagPokok, String? totalTagPpn, String? totalTagPph, String? totalByrPokok, String? totalByrPpn, String? totalByrPph}) => HutangPiutangTransaksiModel(
