...
class TransaksiBayarDimukaModel {
  ...
  factory TransaksiBayarDimukaModel.fromJson(Map<String, dynamic> json) => TransaksiBayarDimukaModel(id: json['id'] as int, kodePt: json['kode_pt'].toString(), kodeKantor: json['kode_kantor'].toString(), kodeInduk: json['kode_induk'].toString(), userinput: json['userinput'].toString(), userterm: json['userterm'].toString(), nomorDok: json['nomor_dok'].toString(), nomorRef: json['nomor_ref'].toString(), masaBayar: json['masa_bayar'].toString(), nominal: json['nominal'].toString(), nilaiPengakuan: json['nilai_pengakuan'].toString(), keterangan: json['keterangan'].toString(), debetSbb: json['debet_sbb'].toString(), creditSbb: json['credit_sbb'].toString(), mulaiSusu: json['mulai_susu'].toString(), createddate: json['createddate'].toString(), status: json['status'].toString());
  ...
  TransaksiBayarDimukaModel clone() => TransaksiBayarDimukaModel(id: id, kodePt: kodePt, kodeKantor: kodeKantor, kodeInduk: kodeInduk, userinput: userinput, userterm: userterm, nomorDok: nomorDok, nomorRef: nomorRef, masaBayar: masaBayar, nominal: nominal, nilaiPengakuan: nilaiPengakuan, keterangan: keterangan, debetSbb: debetSbb, creditSbb: creditSbb, mulaiSusu: mulaiSusu, createddate: createddate, status: status);

  TransaksiBayarDimukaModel copyWith({int? id, String? kodePt, String? kodeKantor, String? kodeInduk, String? userinput, String? userterm, String? nomorDok, String? nomorRef, String? masaBayar, String? nominal, String? nilaiPengakuan, String? keterangan, String? debetSbb, String? creditSbb, String? mulaiSusu, String? createddate, String? status}) => TransaksiBayarDimukaModel(
        id: id ?? this.id,
