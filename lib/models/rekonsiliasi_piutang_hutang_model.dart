...
class RekonsiliasiPiutangHutangModel {
  ...
  factory RekonsiliasiPiutangHutangModel.fromJson(Map<String, dynamic> json) => RekonsiliasiPiutangHutangModel(noInvoice: json['no_invoice'].toString(), jnsInvoice: json['jns_invoice'].toString(), noSif: json['no_sif'].toString(), nmSif: json['nm_sif'].toString(), tglInvoice: json['tgl_invoice'].toString(), nilaiInvoice: json['nilai_invoice'].toString(), ppn: json['ppn'].toString(), pph: json['pph'].toString(), tglJtTempo: json['tgl_jt_tempo'].toString(), bertahap: json['bertahap'].toString(), jumlahTahap: json['jumlah_tahap'].toString(), tglBayar: json['tgl_bayar'].toString(), nilaiBayar: json['nilai_bayar'].toString(), statusInvoice: json['status_invoice'].toString(), kodePt: json['kode_pt'].toString(), kodeKantor: json['kode_kantor'].toString(), kodeInduk: json['kode_induk'].toString(), kodeAo: json['kode_ao'].toString(), noReferensi: json['no_referensi'].toString(), saldo: json['saldo'].toString());
  ...
  RekonsiliasiPiutangHutangModel clone() => RekonsiliasiPiutangHutangModel(noInvoice: noInvoice, jnsInvoice: jnsInvoice, noSif: noSif, nmSif: nmSif, tglInvoice: tglInvoice, nilaiInvoice: nilaiInvoice, ppn: ppn, pph: pph, tglJtTempo: tglJtTempo, bertahap: bertahap, jumlahTahap: jumlahTahap, tglBayar: tglBayar, nilaiBayar: nilaiBayar, statusInvoice: statusInvoice, kodePt: kodePt, kodeKantor: kodeKantor, kodeInduk: kodeInduk, kodeAo: kodeAo, noReferensi: noReferensi, saldo: saldo);

  RekonsiliasiPiutangHutangModel copyWith({String? noInvoice, String? jnsInvoice, String? noSif, String? nmSif, String? tglInvoice, String? nilaiInvoice, String? ppn, String? pph, String? tglJtTempo, String? bertahap, String? jumlahTahap, String? tglBayar, String? nilaiBayar, String? statusInvoice, String? kodePt, String? kodeKantor, String? kodeInduk, String? kodeAo, String? noReferensi, String? saldo}) => RekonsiliasiPiutangHutangModel(
